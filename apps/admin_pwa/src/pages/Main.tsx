...
function HomePage() {
  const [currentStatusA, setCurrentStatusA] = useState<StatusTuple>([
    false,
    false,
    false,
    false,
  ...
  const [currentStatusB, setCurrentStatusB] = useState<StatusTuple>([
    false,
    false,
    false,
    false,
  ...
  return (
    <PageBox>
      <ScrollBox style={ScrollBoxStyle}>
        <StudentCheckBox
          status={currentStatusA}
          alpha={"A"}
          name={"장성주"}
          room={RoomData[currentFloor][currentRoomIdx]}
          changeCheck={changeCheck}
        />
        <StudentCheckBox
          status={currentStatusB}
          alpha={"B"}
          name={"장성주"}
          room={RoomData[currentFloor][currentRoomIdx]}
          changeCheck={changeCheck}
      ...
      <Navbar
        ...
        setRoomIdx={setCurrentRoomIdx}
        floorRooms={RoomData[currentFloor]}
      />
    </PageBox>
  );
}
